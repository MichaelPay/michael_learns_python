...
# Return all Challenges where the name field contains name argument and the language field
# is equal to the language argument.
# Use == for equality. You don't need boolean and or binary &
# for this, just put both conditions in your where().
