...
But be careful! The grue is hiding somewhere
inside!
...
python -m doctest dd_game_testing.py

(tests strings with results, floats may have issues)
...
def get_locations(cells):
    """Randomly pick starting locations for the monster,
